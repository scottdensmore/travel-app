...
Read both this file and `AGENTS.md` from disk when reasoning about them. A
definition injected into your context is a snapshot from when you were invoked
and can lag the worktree you are certifying — that has already produced a draft
naming checks the real file had removed.
